...
override SRC_AUX+= ../BilatTools_Cuda_smart_switch/src/core
override SRC_AUX+= ../BilatTools_Image/src/core

override SRC_AUX+= ../BilatTools_OpenCV/src/core
...
#	Mimimum : empty
override CODE_DEFINE_VARIABLES+=CBI_NO_CUDA
